...
import {ASTBuilder as Builder} from './ast/ASTBuilder.js'; var ASTBuilder = new Builder();
...
var grammar = {
    ...
    {"name": "statement", "symbols": ["question"], "postprocess": ASTBuilder.statement},
    {"name": "statement", "symbols": ["answer"], "postprocess": ASTBuilder.statement},
    {"name": "statement", "symbols": ["if_statement"], "postprocess": ASTBuilder.statement},
    {"name": "statement", "symbols": ["ifelse_statement"], "postprocess": ASTBuilder.statement},
    ...
    {"name": "factor", "symbols": ["propertyName"], "postprocess": ASTBuilder.property},
