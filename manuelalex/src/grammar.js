...
var grammar = {
    ...
    {"name": "if_statement", "symbols": ["if_statement$string$1", "_", {"literal":"("}, "expression", {"literal":")"}, "body"], "postprocess": FormPostProcessor.ifStatement},
    ...
    {"name": "comparison", "symbols": ["comparison", "_", "comparison$subexpression$1", "_", "comparison"], "postprocess": FormPostProcessor.deepExpression},
    {"name": "plus_minus_expression", "symbols": ["multiply_divide_expression"]},
    {"name": "plus_minus_expression$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "plus_minus_expression$subexpression$1", "symbols": [{"literal":"+"}]},
    {"name": "plus_minus_expression", "symbols": ["plus_minus_expression", "_", "plus_minus_expression$subexpression$1", "_", "plus_minus_expression"], "postprocess": FormPostProcessor.deepExpression},
    ...
    {"name": "propertyName", "symbols": ["propertyName$ebnf$1"], "postprocess": FormPostProcessor.property},
