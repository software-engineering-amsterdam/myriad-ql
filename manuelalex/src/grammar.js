...
function $(o) {
 ...
 var grammar = {
    ...
    {"name": "form", "symbols": ["form$string$1", "formName", "_", "openBrace", "_", "form$ebnf$1", "_", "form$ebnf$2", "_", "form$ebnf$3", "_", "closedBrace"], "postprocess": FormPostProcessor.form},
    ...
    {"name": "allocation", "symbols": ["propertyName", "allocation$string$1", "_", "propertyType", "space", "assignOp", "space", "expression", "allocation$ebnf$1"]},
