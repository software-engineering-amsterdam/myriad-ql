...
function $(o) {
 ...
 let FormPostProcessor = require('./processors/FormPostProcessor.js'); var grammar = {
    ...
    {"name": "form", "symbols": ["form$string$1", "formName", "openBrace", "newLine", "form$ebnf$1", "newLine", "closedBrace"], "postprocess": FormPostProcessor.form},
    ...
    {"name": "if_statement", "symbols": ["if_statement$string$1", "parOpen", "propertyName", "parClose", "space", "openBrace", "newLine", "if_statement$ebnf$1", "newLine", "closedBrace"], "postprocess": FormPostProcessor.ifStatement},
    ...
    {"name": "operator", "symbols": [{"literal":"-"}]},
    {"name": "operator", "symbols": [{"literal":"*"}]},
    {"name": "operator", "symbols": [{"literal":"/"}], "postprocess": FormPostProcessor.operator},
