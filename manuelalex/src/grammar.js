...
function $(o) {
 ...
 var grammar = {
    ...
    {"name": "conditional", "symbols": ["parOpen", "or_test", "parClose"]},
    ...
    {"name": "or_test", "symbols": ["and_test"]},
    {"name": "or_test$subexpression$1$string$1", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "or_test$subexpression$1", "symbols": ["or_test$subexpression$1$string$1"]},
    {"name": "or_test$subexpression$1", "symbols": [{"literal":"|"}]},
    {"name": "or_test", "symbols": ["or_test", "_", "or_test$subexpression$1", "_", "and_test"]},
