...
var grammar = {
    ...
    {"name": "not_expression", "symbols": [{"literal":"!"}, "not_expression"], "postprocess": FormPostProcessor.expression},
    ...
    {"name": "comparison", "symbols": ["comparison", "_", "comparison$subexpression$1", "_", "comparison"], "postprocess": FormPostProcessor.expression},
