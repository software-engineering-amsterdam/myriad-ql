...
var grammar = {
    ...
    {"name": "conditional", "symbols": [{"literal":"("}, "or_expression", {"literal":")"}]},
    ...
    {"name": "allocation$subexpression$1", "symbols": ["or_expression"]},
    ...
    {"name": "or_expression$subexpression$1$string$1", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "or_expression$subexpression$1", "symbols": ["or_expression$subexpression$1$string$1"]},
    {"name": "or_expression", "symbols": ["or_expression", "_", "or_expression$subexpression$1", "_", "and_expression"], "postprocess": FormPostProcessor.booleanExpression},
    {"name": "and_expression", "symbols": ["not_expression"]},
    {"name": "and_expression$subexpression$1$string$1", "symbols": [{"literal":"&"}, {"literal":"&"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "and_expression$subexpression$1", "symbols": ["and_expression$subexpression$1$string$1"]},
    {"name": "and_expression", "symbols": ["and_expression", "_", "and_expression$subexpression$1", "_", "not_expression"], "postprocess": FormPostProcessor.and_test},
    {"name": "not_expression", "symbols": ["comparison"]},
    {"name": "not_expression", "symbols": [{"literal":"!"}, "not_expression"]},
    {"name": "not_expression", "symbols": ["propertyName"], "postprocess": FormPostProcessor.not_test},
    ...
    {"name": "comparison", "symbols": ["comparison", "_", "comparison$subexpression$1", "_", "plus_minus_expression"], "postprocess": FormPostProcessor.comparison},
    {"name": "plus_minus_expression", "symbols": ["multiply_divide_expression"]},
    {"name": "plus_minus_expression$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "plus_minus_expression$subexpression$1", "symbols": [{"literal":"+"}]},
    {"name": "plus_minus_expression", "symbols": ["plus_minus_expression", "plus_minus_expression$subexpression$1", "multiply_divide_expression"], "postprocess": FormPostProcessor.expression},
    {"name": "multiply_divide_expression", "symbols": ["factor"]},
    {"name": "multiply_divide_expression$subexpression$1", "symbols": [{"literal":"/"}]},
    {"name": "multiply_divide_expression$subexpression$1", "symbols": [{"literal":"*"}]},
    {"name": "multiply_divide_expression", "symbols": ["multiply_divide_expression", "multiply_divide_expression$subexpression$1", "factor"]},
    {"name": "factor", "symbols": ["digits"]},
    {"name": "factor", "symbols": ["propertyName"]},
    {"name": "factor", "symbols": [{"literal":"("}, "or_expression", {"literal":")"}]},
