...
function $(o) {
 ...
 let FormPostProcessor = require('./processors/FormPostProcessor.js'); var grammar = {
    ...
    {"name": "expression", "symbols": ["expression", "space", "expression$subexpression$1", "space", "term"], "postprocess": FormPostProcessor.expression},
    {"name": "term", "symbols": ["factor"]},
    {"name": "term$subexpression$1", "symbols": ["divide_op"]},
    {"name": "term$subexpression$1", "symbols": ["multiply_op"]},
    {"name": "term", "symbols": ["term", "space", "term$subexpression$1", "space", "factor"]},
