...
function $(o) {
 ...
 let FormPostProcessor = require('./processors/FormPostProcessor.js'); var grammar = {
    ParserRules: [
    ...
    {"name": "form", "symbols": ["form$string$1", "formName", "openBrace", "newLine", "statements", "newLine", "closedBrace"], "postprocess": FormPostProcessor.form},
    ...
    {"name": "statements", "symbols": ["statements$ebnf$1"], "postprocess": FormPostProcessor.statements},
    ...
    {"name": "question", "symbols": ["question$string$1", "prime", "sentence", "prime", "newLine", "propertyName", {"literal":":"}, "space", "propertyType", "newLine"], "postprocess": FormPostProcessor.question},
    {"name": "if_statement$string$1", "symbols": [{"literal":"i"}, {"literal":"f"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "if_statement", "symbols": ["if_statement$string$1", "parOpen", "propertyName", "parClose", "space", "openBrace", "newLine", "statements", "newLine", "closedBrace"], "postprocess": FormPostProcessor.ifStatement},
    ...
    {"name": "answer", "symbols": ["answer$string$1", "prime", "sentence", "prime", "newLine", "allocation"], "postprocess": FormPostProcessor.answer},
    {"name": "allocation$string$1", "symbols": [{"literal":":"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "allocation", "symbols": ["propertyName", "allocation$string$1", "propertyType", "space", "assignOp", "space", "expression", "newLine"]},
    {"name": "expression", "symbols": [{"literal":"("}, "propertyName", "space", "operator", "space", "propertyName", {"literal":")"}], "postprocess": FormPostProcessor.expression},
    ...
    {"name": "letters", "symbols": ["letters$ebnf$1"], "postprocess": FormPostProcessor.toString},
