...
var grammar = {
    ...
    {"name": "form", "symbols": ["form$string$1", "_", "formName", "_", {"literal":"{"}, "_", "form$ebnf$1", {"literal":"}"}], "postprocess": ASTBuilder.form},
    ...
    {"name": "statement", "symbols": ["ifelse_statement"]},
    ...
    {"name": "question", "symbols": ["question$string$1", "_", {"literal":"'"}, "sentence", {"literal":"'"}, "_", "propertyName", {"literal":":"}, "_", "propertyType", "_"], "postprocess": ASTBuilder.question},
    {"name": "ifelse_statement", "symbols": ["if_statement", "else_clause"], "postprocess": ASTBuilder.ifElseStatement},
    {"name": "if_statement$string$1", "symbols": [{"literal":"i"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "if_statement", "symbols": ["if_statement$string$1", "_", {"literal":"("}, "expression", {"literal":")"}, "body"], "postprocess": ASTBuilder.ifStatement},
    {"name": "else_clause$string$1", "symbols": [{"literal":"e"}, {"literal":"l"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "else_clause", "symbols": ["else_clause$string$1", "body"]},
    {"name": "body$ebnf$1", "symbols": []},
    {"name": "body$ebnf$1", "symbols": ["statement", "body$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "body", "symbols": ["_", {"literal":"{"}, "_", "body$ebnf$1", {"literal":"}"}, "_"]},
    ...
    {"name": "answer", "symbols": ["answer$string$1", "_", {"literal":"'"}, "sentence", {"literal":"'"}, "_", "allocation", "_"], "postprocess": ASTBuilder.answer},
    {"name": "allocation$subexpression$1", "symbols": ["expression"]},
    {"name": "allocation", "symbols": ["propertyName", {"literal":":"}, "_", "propertyType", "_", {"literal":"="}, "_", "allocation$subexpression$1"], "postprocess": ASTBuilder.allocation},
    ...
    {"name": "expression", "symbols": ["expression", "_", "expression$string$1", "_", "expression"], "postprocess": ASTBuilder.expression},
    ...
    {"name": "and_expression", "symbols": ["and_expression", "_", "and_expression$string$1", "_", "and_expression"], "postprocess": ASTBuilder.expression},
    {"name": "not_expression", "symbols": ["comparison"]},
    {"name": "not_expression", "symbols": [{"literal":"!"}, "not_expression"], "postprocess": ASTBuilder.prefixExpression},
    ...
    {"name": "comparison", "symbols": ["comparison", "_", "comparison$subexpression$1", "_", "comparison"], "postprocess": ASTBuilder.deepExpression},
    {"name": "plus_minus_expression", "symbols": ["multiply_divide_expression"]},
    {"name": "plus_minus_expression$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "plus_minus_expression$subexpression$1", "symbols": [{"literal":"+"}]},
    {"name": "plus_minus_expression", "symbols": ["plus_minus_expression", "_", "plus_minus_expression$subexpression$1", "_", "plus_minus_expression"], "postprocess": ASTBuilder.deepExpression},
    {"name": "multiply_divide_expression", "symbols": ["atom"]},
    ...
    {"name": "atom$ebnf$1", "symbols": [/[0-9]/]},
    {"name": "atom$ebnf$1", "symbols": [/[0-9]/, "atom$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "atom", "symbols": ["atom$ebnf$1"], "postprocess": ASTBuilder.numbers},
    {"name": "atom$string$1", "symbols": [{"literal":"t"}, {"literal":"r"}, {"literal":"u"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "atom", "symbols": ["atom$string$1"], "postprocess": ASTBuilder.reservedBooleanWords},
    {"name": "atom$string$2", "symbols": [{"literal":"f"}, {"literal":"a"}, {"literal":"l"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "atom", "symbols": ["atom$string$2"], "postprocess": ASTBuilder.reservedBooleanWords},
    {"name": "atom", "symbols": ["propertyName"]},
    {"name": "atom", "symbols": [{"literal":"("}, "expression", {"literal":")"}], "postprocess": (data)=> data[1]},
    {"name": "propertyName$ebnf$1", "symbols": [/[A-Za-z]/]},
    {"name": "propertyName$ebnf$1", "symbols": [/[A-Za-z]/, "propertyName$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    ...
    {"name": "propertyType", "symbols": ["propertyType$string$1"], "postprocess": ASTBuilder.boolean},
    ...
    {"name": "propertyType", "symbols": ["propertyType$string$2"], "postprocess": ASTBuilder.string},
    ...
    {"name": "propertyType", "symbols": ["propertyType$string$3"], "postprocess": ASTBuilder.number},
    {"name": "propertyType$string$4", "symbols": [{"literal":"d"}, {"literal":"a"}, {"literal":"t"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "propertyType", "symbols": ["propertyType$string$4"], "postprocess": ASTBuilder.date},
    ...
    {"name": "propertyType", "symbols": ["propertyType$string$5"], "postprocess": ASTBuilder.number},
    ...
    {"name": "propertyType", "symbols": ["propertyType$string$6"], "postprocess": ASTBuilder.money},
