...
class TestBooleanTypeChecker(Shared):
    def test_boolean_negation_boolean(self):
        ...
        self.assertEqual(False, environment[expected_identifier], "Evaluation should result in 2")
    ...
    def test_boolean_and_boolean_and_boolean(self):
        ...
        expected_identifier = 'valueResidue'
        self.assertTrue(expected_identifier in environment, "Environment should contain key hasSoldHouse")
        self.assertEqual(True, environment[expected_identifier], "Evaluation should result in 2")
