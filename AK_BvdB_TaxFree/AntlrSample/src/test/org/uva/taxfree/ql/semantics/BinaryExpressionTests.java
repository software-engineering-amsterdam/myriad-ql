...
public class BinaryExpressionTests extends SemanticsTester {
    ...
    private void assertThat(String leftHand, Operator operator, String rightHand, String expected) {
        assertThat(new StringLiteralNode(leftHand, emptySource()), operator, new StringLiteralNode(rightHand, emptySource()), expected);
    }

    private void assertThat(boolean leftHand, Operator operator, boolean rightHand, String expected) {
        assertThat(new BooleanLiteralNode(leftHand, emptySource()), operator, new BooleanLiteralNode(rightHand, emptySource()), expected);
    }

    private void assertThat(int leftHand, Operator operator, int rightHand, String expected) {
        assertThat(new IntegerLiteralNode(leftHand, emptySource()), operator, new IntegerLiteralNode(rightHand, emptySource()), expected);
    }

    private void assertThat(LiteralNode leftHand, Operator operator, LiteralNode rightHand, String expectedResult) {
