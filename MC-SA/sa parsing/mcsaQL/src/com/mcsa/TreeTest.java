...
public class TreeTest {
    ...
    TreeTest() {
        ...
        System.out.println(child2.isInChildren("child6"));
        System.out.println(child1.isInChildren("child6"));
        parseTree(testtree);
    }

    public static void parseTree (TreeNode<String> printChild) {
        if (printChild.getValue()!="-> form") {
            System.out.println(printChild.getValue() + "  parent  " + printChild.getParent().getValue());
        }
