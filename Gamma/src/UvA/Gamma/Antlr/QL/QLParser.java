...
public class QLParser extends Parser {
    ...
    public static class QuestionContext extends ParserRuleContext {
        public TerminalNode STRING_LITERAL() {
            return getToken(QLParser.STRING_LITERAL, 0);
        }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode DATE() {
            return getToken(QLParser.DATE, 0);
        }
    ...
    public static class MoneyExpressionContext extends ExpressionContext {
        ...
        public MoneyExpressionContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NumExprContext extends ParserRuleContext {
        ...
        public TerminalNode NUMBER() {
            return getToken(QLParser.NUMBER, 0);
        }
